...
export interface AddressQueueMockInterface extends utils.Interface {
  functions: {
    "dequeue()": FunctionFragment;
    "enqueue(address)": FunctionFragment;
  ...
  events: {
    "OperationResult(address)": EventFragment;
  };
...
export interface AddressQueueMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AddressQueueMockInterface;
  ...
  filters: {
    "OperationResult(address)"(data?: null): OperationResultEventFilter;
