...
export interface Bytes32QueueMockInterface extends utils.Interface {
  functions: {
...
export interface Bytes32QueueMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Bytes32QueueMockInterface;
